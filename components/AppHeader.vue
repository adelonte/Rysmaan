      ...
      <div class="flex h-20 items-center justify-between">
        <div class="flex items-center">
          <NuxtLink to="/" class="flex items-center space-x-2">
            <img src="/logo.png" alt="Rysmaan Logo" class="h-16 mix-blend-multiply brightness-[1.1] contrast-[1.1] dark:hidden" />
            <img src="/logo.png" alt="Rysmaan Logo" class="hidden dark:block h-16 mix-blend-screen brightness-200 contrast-200" />
          </NuxtLink>
        </div>
