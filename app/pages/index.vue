...
/**
 * The home page: says what Rysmaan is and nothing more, built in the full-bleed
 * scene + glass card language of the reference design. The previous product
 * landing page lives on at /v2; see app/layouts/v2.vue for why this page shares
 * none of its chrome.
 */
